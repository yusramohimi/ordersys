    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 ml-64 overflow-auto p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          {[
            { title: "Total Revenue", value: "$42,892", change: "+12%", icon: "↑", color: "bg-green-100", textColor: "text-green-600" },
            { title: "Orders", value: "1,258", change: "+8%", icon: "↑", color: "bg-blue-100", textColor: "text-blue-600" },
            { title: "Customers", value: "2,458", change: "+5%", icon: "↑", color: "bg-purple-100", textColor: "text-purple-600" },
            { title: "Conversion", value: "3.2%", change: "-0.5%", icon: "↓", color: "bg-red-100", textColor: "text-red-600" },
          ].map((metric, i) => (
            <div key={i} className="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-sm text-gray-500 mb-1">{metric.title}</p>
                  <h3 className="text-2xl font-bold text-gray-800">{metric.value}</h3>
                  <div className="flex items-center mt-2">
                    <span className={`text-xs ${metric.textColor} flex items-center`}>
            ...
            <div className="p-5">
              ...
              <div className="grid grid-cols-3 gap-4 mt-4 text-center">
                {[
                  ...
                  <div key={i}>
                    <div className={`h-3 w-3 rounded-full mx-auto ${source.color}`}></div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  {["Transaction ID", "Customer", "Date", "Amount", "Status", "Action"].map((header, i) => (
              ...
              <tbody className="divide-y divide-gray-100">
                {[
                  { id: "#TRX7891", name: "Alex Johnson", date: "15 May, 2023", amount: "$245.00", status: "Completed" },
                  { id: "#TRX7890", name: "Maria Garcia", date: "14 May, 2023", amount: "$189.50", status: "Pending" },
                  { id: "#TRX7889", name: "David Wilson", date: "14 May, 2023", amount: "$320.75", status: "Completed" },
                  { id: "#TRX7888", name: "Sarah Miller", date: "13 May, 2023", amount: "$95.20", status: "Failed" },
                  { id: "#TRX7887", name: "James Brown", date: "12 May, 2023", amount: "$450.00", status: "Completed" },
                ].map((txn, i) => (
